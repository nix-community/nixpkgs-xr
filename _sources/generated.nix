...
}:
{
  ...
  monado = {
    pname = "monado";
    version = "f4dc0ec36e1109a997c8b388fb30de3cf1dc01b0";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/monado/monado.git";
      rev = "f4dc0ec36e1109a997c8b388fb30de3cf1dc01b0";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-MPdJVonxPmeJWUMIuEcoTabc0s6MZmQYToq0hjhSakk=";
    };
    date = "2026-04-05";
  };
  opencomposite = {
  ...
  wayvr = {
    pname = "wayvr";
    version = "18f99b5dafb66cf7f166840ac6ee348c80851bac";
    src = fetchFromGitHub {
      owner = "wlx-team";
      repo = "wayvr";
      rev = "18f99b5dafb66cf7f166840ac6ee348c80851bac";
      fetchSubmodules = false;
      sha256 = "sha256-vlBzBoNH7qo1W6k9LMuNwh9PHhhnotdfWPhc15WmyAI=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-vlBzBoNH7qo1W6k9LMuNwh9PHhhnotdfWPhc15WmyAI=/Cargo.lock";
      outputHashes = {
  ...
  wivrn = {
    pname = "wivrn";
    version = "6c6519fab53073df83d7d10ce6b261c3902392b1";
    src = fetchFromGitHub {
      owner = "WiVRn";
      repo = "WiVRn";
      rev = "6c6519fab53073df83d7d10ce6b261c3902392b1";
      fetchSubmodules = false;
      sha256 = "sha256-s7wVkBNnlDOyfPzoTmFuvScmycHjQsA4mcb6lCljyXk=";
    };
    date = "2026-04-04";
  };
  wivrn-monado = {
