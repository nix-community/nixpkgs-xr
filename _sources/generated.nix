...
}:
{
  ...
  monado = {
    pname = "monado";
    version = "fea2ceb6f5ccd81d1f3f60edbadc8e93e52e3581";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/monado/monado.git";
      rev = "fea2ceb6f5ccd81d1f3f60edbadc8e93e52e3581";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-EGm5u0MF+1o9QnTTh4dTt6jhZZDta4B7Kjir4/PydwA=";
    };
    date = "2026-05-01";
  };
  opencomposite = {
  ...
  wayvr = {
    pname = "wayvr";
    version = "6b81f07cc805c818791682f725f9f32f7bab7794";
    src = fetchFromGitHub {
      owner = "wlx-team";
      repo = "wayvr";
      rev = "6b81f07cc805c818791682f725f9f32f7bab7794";
      fetchSubmodules = false;
      sha256 = "sha256-epLAFAtMLUkTSQtuRLoJO55oR5VBN2KiH9ObcQI7LnE=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-epLAFAtMLUkTSQtuRLoJO55oR5VBN2KiH9ObcQI7LnE=/Cargo.lock";
      outputHashes = {
  ...
  wivrn = {
    pname = "wivrn";
    version = "7e81f23f0fba4a3da8791c0a7c7a25800b910bf3";
    src = fetchFromGitHub {
      owner = "WiVRn";
      repo = "WiVRn";
      rev = "7e81f23f0fba4a3da8791c0a7c7a25800b910bf3";
      fetchSubmodules = false;
      sha256 = "sha256-ZehecdGkw2zSiHDwbMdA9cYGFjLSeOP0hxOhLFqLBg0=";
    };
    date = "2026-05-02";
  };
  wivrn-monado = {
