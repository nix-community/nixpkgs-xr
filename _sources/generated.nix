...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  monado = {
    pname = "monado";
    version = "6f1d5318a37dcc08be4ef75a9867073fd527ed5a";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/monado/monado.git";
      rev = "6f1d5318a37dcc08be4ef75a9867073fd527ed5a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-vAZiXty+Bl3ZsMEHPeS+8c23C7N1P1G02LoV8zyDzmg=";
    };
    date = "2025-07-15";
  };
  opencomposite = {
  ...
  xrizer = {
    pname = "xrizer";
    version = "a0679535696023bd4cac16b8dae020b9fe1d7e6c";
    src = fetchgit {
      url = "https://github.com/Supreeeme/xrizer.git";
      rev = "a0679535696023bd4cac16b8dae020b9fe1d7e6c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-5sHotY9g858DditmXiHOWexRcvdjDYdofubVKYp8bME=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./xrizer-a0679535696023bd4cac16b8dae020b9fe1d7e6c/Cargo.lock;
      outputHashes = {
        "openxr-0.19.0" = "sha256-mljVBbQTq/k7zd/WcE1Sd3gibaJiZ+t7td964clWHd8=";
      };
    };
