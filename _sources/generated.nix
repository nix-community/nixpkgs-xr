...
}:
{
  ...
  monado = {
    pname = "monado";
    version = "c9ae292ca624fe32f2f095dfd2591d412fc03425";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/monado/monado.git";
      rev = "c9ae292ca624fe32f2f095dfd2591d412fc03425";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-8FccEjjOKW/xUVmOkUAp1RlACVjtZqWoy8IlwD/smH4=";
    };
    date = "2026-06-23";
  };
  opencomposite = {
  ...
  wayvr = {
    pname = "wayvr";
    version = "5723c3c1df31b332a54f59161762d41dd3bd4ff2";
    src = fetchFromGitHub {
      owner = "wlx-team";
      repo = "wayvr";
      rev = "5723c3c1df31b332a54f59161762d41dd3bd4ff2";
      fetchSubmodules = false;
      sha256 = "sha256-OLd7QKag/hsZ57o8jXMTBI0mAqHzaBMkn197ZUhybuA=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-OLd7QKag_hsZ57o8jXMTBI0mAqHzaBMkn197ZUhybuA=/Cargo.lock";
      outputHashes = {
